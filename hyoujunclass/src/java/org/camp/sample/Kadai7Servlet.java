...
public class Kadai7Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        */
        ...
        out.print(chikan+"<br>");
        String U = chikan.replace("U","う");
        out.print("「U」⇒「う」"+"<br>"+U+"<br>");
        String I = chikan.replace("I","い");
        out.print("「I」⇒「い」"+"<br>"+I+"<br>");
        String UI = I.replace("U","う");
        out.print("「I」⇒「い」、「U」⇒「う」"+"<br>"+UI+"<br>");
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>標準クラスの課題７</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("</body>");
            out.println("</html>");
