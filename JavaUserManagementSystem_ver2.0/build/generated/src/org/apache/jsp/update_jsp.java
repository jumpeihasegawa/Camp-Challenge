...
public final class update_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (udd.getBirthday() != null) {
      ...
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("        <!--ただし初めはresult_detail.javaから個人のデータを受け取り、フォーム内に直接記入された状態である。このフォームの内容を書き換えていくことでデータの更新ができる-->\n");
 ...
 for (int i = 1; i <= 3; i++) {
      ...
      out.write('"');
      out.write(' ');
if(input && udd.getType() == i){out.print("checked");}
      out.write('>');
