 ...
 * @author Jumpei
 */
public class Kadai11Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            db_st = db_con.prepareStatement("UPDATE profiles SET name=?,age=?,birthday=?,tell=? WHERE profilesID=?;");
            db_st.setString(1, name);
            db_st.setInt(2, ageInt);
            db_st.setString(3, birthday);
            db_st.setString(4, tell);
            db_st.setInt(5, ProfilesIDInt);
        ...
        getServletConfig().getServletContext().
                getRequestDispatcher("/Kadai11.jsp").
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Kadai11Servlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Kadai11Servlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
