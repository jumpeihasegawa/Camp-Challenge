    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            while (db_data.next()) {
                ...
                hs.setAttribute("ProfilesID" + i, ProfilesID);
                hs.setAttribute("name" + i, name);
                hs.setAttribute("tell" + i, tell);
                hs.setAttribute("age" + i, age);
                hs.setAttribute("birthday" + i, birthday);
        ...
        getServletConfig().getServletContext().
                getRequestDispatcher("/Kadai8.jsp").
        ...
        try {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Kadai8Servlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
